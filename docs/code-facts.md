...
## REST routes (42) — server.js, one Express app
...
- `app/(tabs)/chats.tsx` → PATCH /api/conversations/:id/archive, POST /api/conversations/:id/resume, POST /api/conversations/:id/takeover, GET /api/conversations/:id/handoff, POST /api/whatsapp/send
- `app/(tabs)/inventory.tsx` → POST /api/sales/:id/confirm, POST /api/sales/:id/reject
...
- `src/components/sales/PendingDetailSheet.tsx` → POST /api/sales/:id/confirm, POST /api/sales/:id/reject
...
- `src/hooks/useSales.ts` → POST /api/sales/:id/confirm, POST /api/sales/:id/reject
